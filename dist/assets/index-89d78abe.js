...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Sa(){return new wn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:ls(),fragmentShader:`
		...
		`,blending:ln,depthTest:!1,depthWrite:!1})}function Ea(){return new wn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:ls(),fragmentShader:`
